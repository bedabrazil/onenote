...
n1 = Note.create user: u2, title: 'Bootcamp 2 OneBitCode', body: 'Vai ser incrível :)'
n2 = Note.create user: u1, title: 'Aprender Rails', body: 'De maneira fácil :)'
...
TagsNote.create tag: t1, note: n2
TagsNote.create tag: t2, note: n1